  ...
  return (
    <div name='work' className='w-full md:h-screen text-gray-300 bg-[#0a192f]'>
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        ...
        {/* Grid Item */}
          <div
            style={{ backgroundImage: `url(${Memories})`,"background-size": "100% 100%" }}
          ...
          >
            ...
            {/* Grid Item */}
          <div
            style={{ backgroundImage: `url(${Terra})`,"background-size": "100% 100%"}}
          ...
          <div
            style={{ backgroundImage: `url(${Twig})`,"background-size": "100% 100%" }}
